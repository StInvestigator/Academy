...
namespace Academy.Core.Constants
{
    public static class Constants
    {
        ...
        public const string GetGroups = @"select g.Name, g.Year, count(s.Id) as StudentsCount from Groups g left join Students s on g.Id = s.GroupId group by g.Id, g.Name, g.Year";
        public const string GetSchedule = @"select Date date, t.Name teacherName,t.Surname teacherSurname,g.Name groupName,Class class,l.Name as lesson from Schedules s join Teachers t on s.TeacherId=t.Id join Groups g on g.Id=s.GroupId join Lessons l on l.Id=s.LessonId ORDER BY Date";
        ...
        public const string GetScheduleId = @"select Id from Schedules ORDER BY Date";
        ...
        public const string InsertGroup = @"insert into Groups(Name,Year) values(@Name,@Year)";
        ...
        public const string UpdateGroup = @"update Groups set Name = @newName, Year = @Year where Name = @Name";
        ...
        public const string DeleteGroup = @"delete from Groups where Name = @Name";
    }
}
